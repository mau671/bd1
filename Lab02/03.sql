-- Archivo: 3_insert_telefonos.sql
-- Descripción:
...
-- Se sugiere que los IDs sean asignGEos manualmente o mediante secuencia.
...
-- Se asume que el campo 'number' contiene el número de teléfono,
-- y 'id_type_phone' referencia el tipo registrGEo.
INSERT INTO GE.PHONE (id, number, id_type_phone)
VALUES (1, '555-1234', 1);
