...
-- Se le da permiso a CU de seleccionar y dar permisos en la tabla deparment:
GRANT SELECT ON GE.DEPARTMENT TO CU WITH GRANT OPTION;
...
-- Ahora se intenta hacer un select desde TA:
SELECT * from GE.DEPARTMENT;